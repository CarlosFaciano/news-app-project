...
export default function SecondNew({title,description,handleLinkClick,image}) {
  return (
    <div className=" h-full w-screen flex justify-evenly group mt-5 ">
          <section className="flex flex-col items-center w-1/2 mb-2 me-2">
            ...
            {/* <Link className="mt-auto mb-5" href={urlLink3}> */}
